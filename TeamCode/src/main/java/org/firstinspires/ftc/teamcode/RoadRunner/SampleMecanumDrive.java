...
public class SampleMecanumDrive extends MecanumDrive {
    ...
    public SampleMecanumDrive(HardwareMap hardwareMap, RobotSystem robot) {
        ...
        leftFront = (DcMotorEx) robot.hardwareRobot.leftFront;
        leftBack = (DcMotorEx) robot.hardwareRobot.leftBack;
        rightBack = (DcMotorEx) robot.hardwareRobot.rightBack;
        rightFront = (DcMotorEx) robot.hardwareRobot.rightFront;
        ...
        setLocalizer(new PinpointLocalizer(hardwareMap, robot));
    ...
    public double getRawExternalHeading() {
        return robot.hardwareRobot.imu.getRobotYawPitchRollAngles().getYaw(AngleUnit.RADIANS);
    }

    @Override
    public Double getExternalHeadingVelocity() {
        return (double) robot.hardwareRobot.imu.getRobotAngularVelocity(AngleUnit.RADIANS).zRotationRate;
    }
